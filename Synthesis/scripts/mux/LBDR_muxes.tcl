...
compile -exact_map
check_design > ../reports/WARNINGS/WARNINGS_MUX_LBDR.txt
uplevel #0 { report_area } > ../reports/MUX/area_LBDR.txt
uplevel #0 { report_timing -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } >> ../reports/MUX/timing_LBDR.txt
