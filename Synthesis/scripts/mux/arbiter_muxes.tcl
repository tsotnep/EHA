...
compile -exact_map
check_design > ../reports/WARNINGS/WARNINGS_MUX_Arbiter.txt
uplevel #0 { report_area } > ../reports/REPORTS_MUX_Arbiter.txt
uplevel #0 { report_timing -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } >> ../reports/REPORTS_MUX_Arbiter.txt
