...
uplevel #0 { report_area } > ../reports_synopsys/REPORTS_v3.txt

uplevel #0 { report_timing -path full -delay max -nworst 1 -max_paths 1 -significant_digits 2 -sort_by group } >> ../reports_synopsys/REPORTS_v3.txt

check_design > ../reports_synopsys/WARNINGS/WARNINGS_v3.txt
